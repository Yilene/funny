...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	!function (e, t) {
	   true ? module.exports = t() : "function" == typeof define && define.amd ? define("Router", [], t) : "object" == typeof exports ? exports.Router = t() : e.Router = t();
	}(this, function () {
	  return function (e) {
	    function t(r) {
	          ...
	          var t = this,
	            ...
	            var o = function (e) {
	              e && !function () {
	                ...
	                i = function (o, i) {
	              var a = document.createElement("div");r.className && a.classList.add(r.className), a.innerHTML = i, t._$container.appendChild(a), !n && t._options.enter && o && a.classList.add(t._options.enter), t._options.enterTimeout > 0 ? setTimeout(function () {
	                ...
	                a = s.hasChildren(t._$container);o(a);var u = function (e) {
	    ...
	    function r(e) {
	      ...
	      var n = e.source.match(/\((?!\?)/g);if (n) for (var r = 0; r < n.length; r++) t.push({ name: r, prefix: null, delimiter: null, optional: !1, repeat: !1, pattern: null });return l(e, t);
	    }function p(e, t, n) {
	      for (var r = [], o = 0; o < e.length; o++) r.push(v(e[o], t, n).source);var i = new RegExp("(?:" + r.join("|") + ")", c(n));return l(i, t);
	    }function h(e, t, n) {
	      for (var o = r(e), i = d(o, n), a = 0; a < o.length; a++) "string" != typeof o[a] && t.push(o[a]);return l(i, t);
	    }function d(e, t) {
